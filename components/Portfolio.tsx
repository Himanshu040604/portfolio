          ...
          <AnimatedSection id="about">
            <section className="bg-white dark:bg-gray-800 shadow-lg sm:rounded-lg p-6 mb-6 transition-all duration-300 hover:shadow-xl">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                In August 2024, I completed a 3-month internship at IIT Bhilai, where I gained hands-on experience with neural networks, deep learning concepts like UNet, and specialized in AI tools. I've also been actively expanding my expertise in GANs, LLMs, and RAG models and have participated in 4 hackathons, enhancing my problem-solving skills and applying technical knowledge in real-world challenges.
              </p>
            </section>
          </AnimatedSection>
